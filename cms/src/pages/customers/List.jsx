                ...
                <Row>
                    ...
                    <Col xs="auto">
                        <Link to="/customers/create" className="btn btn-dark">
                            <i className="fa-solid fa-plus me-2"></i>Add Customers
                        </Link>
                    </Col>
                </Row>
                {loading ? <Loading/> : <Row>
                    <Col>
                        <DataTable searchable={['Name','Email','Phone','Address','Status','Created At','Updated At']} sortable={['Name','Email','Phone','Address','Status','Created At','Updated At']} data={customers.map(customer =>{
                            return {
                                'Name': customer.name,

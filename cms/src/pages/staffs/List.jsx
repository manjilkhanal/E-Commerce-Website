    ...
    return <Container>
        <Row>
            <Col xs={12} className="bg-white my-3 py-3 rounded-2 shadow-sm">
                ...
                {loading ? <Loading/> : <Row>
                    <Col>
                        <DataTable searchable={['Name','Email','Phone','Address','Status','Created At','Updated At']} sortable={['Name','Email','Phone','Address','Status','Created At','Updated At']} data={staffs.map(staff =>{
                            return {
                                'Name': staff.name,
                                'Email': staff.email,
                                'Phone': staff.phone,

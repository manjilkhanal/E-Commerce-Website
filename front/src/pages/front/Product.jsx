...
export const Product = () => {
    ...
    <main className="row">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-5 col-md-9 col-sm-3 col-5 mx-auto mt-3">
                                <div className="mb-3">
                                    ...
                                    <input type="number" id="qty" min="1" value={qty} className="form-control" onChange={ev => setQty(parseInt(ev.target.value))}  required />
                                </div>
                            </div>
                                ...
                                {Object.keys(user).length ? <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-3">
                                        <div className="d-flex ratings justify-content-end flex-row-reverse">
                                            <input type="radio" value="5" name="rating" id="rating-5" checked={form.rating == 5} onChange={ev => setInForm(ev, form, setForm)} /><label
                                                htmlFor="rating-5"></label>
                                            <input type="radio" value="4" name="rating" id="rating-4" checked={form.rating == 4} onChange={ev => setInForm(ev, form, setForm)} /><label
                                                htmlFor="rating-4"></label>
                                            <input type="radio" value="3" name="rating" id="rating-3" checked={form.rating == 3} onChange={ev => setInForm(ev, form, setForm)}/><label
                                                htmlFor="rating-3"></label>
                                            <input type="radio" value="2" name="rating" id="rating-2" checked={form.rating == 2} onChange={ev => setInForm(ev, form, setForm)}/><label
                                                htmlFor="rating-2"></label>
                                            <input type="radio" value="1" name="rating" id="rating-1" checked={form.rating == 1} onChange={ev => setInForm(ev, form, setForm)} /><label
                                                htmlFor="rating-1"></label>
                                        </div>
                                    </div>
                                    <div className="mb-3">
                                        <SubmitBtn label="Add Review" loading={loading} icon="fa-star" />
                                    </div>
        ...
        {similar.length ? <ProductsList title="Similar Products" products={similar}

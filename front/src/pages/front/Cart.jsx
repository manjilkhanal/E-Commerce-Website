...
import { clearCart, editCart, removeCart } from "../../store"
                    ...
                    <div className="col-lg-6 col-md-8 col-sm-10 mx-auto table-responsive">
                       {Object.keys(cart).length ?  <form className="row">
                                ...
                                <table className="table table-striped table-hover table-sm">
                                    ...
                                    <tbody>
                                        {Object.keys(cart).map(id =>{
                                            ...
                                            <td>
                                                <button className="btn btn-link text-danger" type="button" onClick={() => handleDelete(id)}><i className="fas fa-times"></i></button>
                                            </td>
                                        </tr>
                                        })}
                                    </tbody>
                            ...
                            <div className="col-12 text-right">
                                ...
                                <button type="button" className="btn btn-outline-success" disabled={loading} onClick={handleCheckout}>{loading ?<i className="fa-solid fa-spinner fa-spin me-2"></i> : null }Checkout</button>
                            </div>
                        </form>: <h4 className="text-center fst-italic text-muted">Shopping Cart is Empty</h4>}
                    </div>
                </div>
            </div>

...
class ProductsController {
    ...
    store = async (req, res, next) => {
        try{
            const { name, summary, description, price, discounted_price,
            category_id, brand_id, status, featured} = req.body

            const images = req.files.map(file =>file.filename)

            await Product.create({name, summary, description, price,
            discounted_price, category_id, brand_id, status,featured, images})
    ...
    update = async (req, res, next) => {
        try{
            ...
            await Product.findByIdAndUpdate(product._id,{name, summary, description,price,
            discounted_price, category_id, brand_id, status,featured, images})
